package com.snut_likelion.domain.ai.controller;

import com.snut_likelion.domain.ai.dto.request.AiChatRequest;
import com.snut_likelion.domain.ai.dto.request.AiSummarizeRequest;
...
import com.snut_likelion.domain.ai.service.AiQueryService;
...
public class AiController {
    ...
    @Operation(summary = "AI chat", description = "AI 챗봇을 호출하고 매핑된 답변을 반환합니다.")
    @PostMapping("/chat")
